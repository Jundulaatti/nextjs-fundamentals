...
export default async function MarketingLayout({
  ...
  return (
    <div className="flex min-h-screen flex-col">
      <header className="border-b border-gray-200 dark:border-gray-600 bg-white dark:bg-[#121212]">
      ...
      <footer className="border-t border-gray-200 dark:border-gray-600 bg-white dark:bg-[#121212]">
